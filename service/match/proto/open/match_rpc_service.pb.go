...
const (
	...
	MatchEventType_MatchmakingSearching MatchEventType = 0
	//PotentialMatchCreated 一个潜在的匹配已经被创建。对于所有新的潜在匹配，不管是否需要接受，都会发出这个消息。
	MatchEventType_PotentialMatchCreated MatchEventType = 1
	//AcceptMatch 玩家已经接受了一场潜在的比赛。这个事件包含了比赛中每个玩家的当前接受状态。缺少的数据意味着AcceptMatch还没有为该玩家调用。
	MatchEventType_AcceptMatch MatchEventType = 2
	//AcceptMatchCompleted 由于玩家接受、玩家拒绝或接受超时，比赛接受完成。
	MatchEventType_AcceptMatchCompleted MatchEventType = 3
	//MatchmakingSucceeded 匹配已经成功完成，并且已经创建了一个游戏会话。
	MatchEventType_MatchmakingSucceeded MatchEventType = 4
	//MatchmakingTimedOut 匹配票因超时而失败。
	MatchEventType_MatchmakingTimedOut MatchEventType = 5
	//MatchmakingCancelled  匹配票已被取消。
	MatchEventType_MatchmakingCancelled MatchEventType = 6
	//MatchmakingFailed
	//匹配票遇到了一个错误。这可能是由于游戏会话队列无法访问或内部错误造成的。
	MatchEventType_MatchmakingFailed MatchEventType = 7
)

var MatchEventType_name = map[int32]string{
	0: "MatchmakingSearching",
	1: "PotentialMatchCreated",
	2: "AcceptMatch",
	3: "AcceptMatchCompleted",
	4: "MatchmakingSucceeded",
	5: "MatchmakingTimedOut",
	6: "MatchmakingCancelled",
	7: "MatchmakingFailed",
}

var MatchEventType_value = map[string]int32{
	"MatchmakingSearching":  0,
	"PotentialMatchCreated": 1,
	"AcceptMatch":           2,
	"AcceptMatchCompleted":  3,
	"MatchmakingSucceeded":  4,
	"MatchmakingTimedOut":   5,
...
func (m *MatchEvent) GetMatchEventType() MatchEventType {
	...
	return MatchEventType_MatchmakingSearching
}
...
var fileDescriptor_f8708cffbfd778c3 = []byte{
	...
	0xc0, 0x2f, 0xe0, 0xc4, 0x81, 0x1b, 0x37, 0xfe, 0x05, 0x37, 0xa2, 0x1e, 0xdd, 0x53, 0xd5, 0x0f,
	...
	0x93, 0x34, 0xce, 0xd3, 0x52, 0xde, 0x74, 0x2d, 0xd9, 0xe3, 0xd9, 0x04, 0xfb, 0x3f, 0x65, 0x80,
	...
	,
}
